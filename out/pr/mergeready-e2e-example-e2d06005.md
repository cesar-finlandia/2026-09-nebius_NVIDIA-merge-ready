...
Branch: `mergeready/e2e-example-e2d06005`
...
## Receipt
## Cost receipt
trace `e2d06005-52d6-4060-a27b-59af95e1c2da` — 1 calls, 100 prompt + 50 completion tokens.
...
### Downgrades
- planner: ultra -> nano (run>=90% of MERGEREADY_RUN_BUDGET_USD or window>=90% of MERGEREADY_BUDGET_USD)
